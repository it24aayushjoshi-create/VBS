...
public class UserController {
    ...
    public String update(@RequestBody UpdateDto obj){
        ...
        if ("name".equals(obj.getKey())) {
            if(obj.getKey().equals(user.getName())){return "Name cannot be same";}
            else{
                user.setName(obj.getValue());
            }
        }
        else if ("password".equals(obj.getKey())) {
            if(obj.getKey().equals(user.getPassword())){return "Password cannot be same";}
            ...
            if(obj.getKey().equals(user.getEmail())){return "Email already exists";}
